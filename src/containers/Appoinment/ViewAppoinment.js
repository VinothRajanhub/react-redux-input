...
function ViewAppoinment(props) {
  ...
  function handleConfirmation(){
    alert("Appoint Booked Successfully");
  }


function showappointhide(){
  if (document.getElementById("updateappoinment").style.display !== "block") {
      
    document.getElementById("updateappoinment").style.display = "block";
    ...
    document.getElementById("viewappointprofile").style.display = "none"; 
 
    document.getElementById("confirmappoint").style.display = "none"; 
    ...
    document.getElementById("editAppointLink").style.display = "none";

    
  } else {
    document.getElementById("updateappoinment").style.display = "none";
    document.getElementById("updatecardetails").style.display = "none";
    document.getElementById("updatepersonaldetails").style.display = "none";
    ...
    document.getElementById("viewappointprofile").style.display = "block"; 
    ...
    document.getElementById("editAppointLink").style.display = "block";  


    document.getElementById("confirmappoint").style.display = "block"; 
...
<p>
      ...
      <p className="editstyle" id="editAppointLink" onClick={showappointhide}>Edit</p>
        {/* Update Appoinment */}
       <div className="updateappoinment" id="updateappoinment" style={{display:"none"}}>
     <h3 style={{ margin: "15px", paddingTop: "20px" }}>
             4)Book Appoinment
           </h3>
       ...
       <div className="flex-style">
         ...
         <input
          type="date"
          className="inputstyle"
          value={props.appoinmentDate}
          onChange={(e) => 
            {
            props.setAppointDate(e.target.value)
            } 
          }
        />
      </div>
      ...
      <div className="flex-style">
        ...
        <input
          type="time"
          className="inputstyle"
          value={props.appoinmentTime}
          onChange={(e) => props.setAppointTime(e.target.value)}
        ></input>
      </div>

      <div style={{margin: "15px 0"}}>
          <button className="usersubmit" onClick={showappointhide}>Update</button>
      </div>
     ...
     {/* Update Appoinment */} 
	        ...
	        <div className="viewstyle" id="viewappointprofile">
        <h3 style={{ margin: "0px 0", paddingTop: "0px" }}>4) Book Appoinment</h3>
        <p>
          You have opted to drop off your vehicle at our service center on
          &nbsp;{props.appoinmentDate}&nbsp;at&nbsp;
          {props.appoinmentTime}
        </p>
      </div>

      <div className="nextstep">
        <button className="appoinsubmit" id="confirmappoint" onClick={handleConfirmation}>Confirm</button>
      </div>
...
const mapStateToprops = (state) => {
  ...
  return {
    ...
    appoinmentDate: state.appoinment.appoinmentDate,
    appoinmentTime: state.appoinment.appoinmentTime
  };
};
...
export default connect(mapStateToprops, mapDispatchToprops)(ViewAppoinment);
